# -*- coding: utf-8 -*-
"""
Created on Sun Apr 26 03:13:49 2020
...
TRUE_VALUE = np.arange(-int(N_STATES + 1), int(N_STATES + 1)+2, 2) / int(N_STATES + 1)
...
def temporal_difference(value, n, alpha):
    ...
    while True:
        ...
        if time < T:
            ...
            if next_state == 0:
                reward = -1
            elif next_state == int(N_STATES+1):
                reward = 1
            else:
                reward = 0
